...
UserInputService.InputEnded:Connect(function(input, gameProcessed)
    if input.KeyCode == Enum.KeyCode[getgenv().KeyTrigger.TriggerBot:upper()] then
...
RunService.RenderStepped:Connect(function()
    if getgenv().TriggerBot.Settings.Mode == "hold" and UserInputService:IsKeyDown(Enum.KeyCode[getgenv().KeyTrigger.TriggerBot:upper()]) then
        TriggerBotAction()
    end
end)
